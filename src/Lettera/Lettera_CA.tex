...
\begin{document}
	\begin{letter}{
		...
		\begin{quotation}
			...
			Al seguente link: \href{\github}{\textit{\github}} è presente la documentazione,
			di seguito esplicitamente catalogati i documenti che hanno 
			subito un incremento di versione rispetto alla PB: 
			\vspace{0.3cm}
