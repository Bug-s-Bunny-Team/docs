...
A causa della scelta del framework Svelte (ToDo: G) la View non è una classe perchè è un Componente Svelte, 
che si compone da un blocco di script, un blocco di Html ed un blocco di stile.
Lo script viene utilizzato soltanto per inizializzare il Presenter ed eventualmente fare il setup del data-binding tra Componente View e Presenter,
per il resto la View è passiva come previsto dal pattern MVP. 
