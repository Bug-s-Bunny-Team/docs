\section{Requisiti di sistema} {
    ...
    L'unico prerequisito necessario ed obbligatorio per utilizzare la WebApp BunnyFood è l'aver installato 
    ed attivato \textbf{JavaScript} sul proprio browser.
    ...
    Nel caso ci si imbatta in problematiche riguardanti il funzionamento di BunnyFood, è possibile
