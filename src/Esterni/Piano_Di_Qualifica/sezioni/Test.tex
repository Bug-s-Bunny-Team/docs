...

{
    ...
    TA7 & Verificare che l’utente non autenticato possa:\begin{enumerate}
    ...
    TA8 & Verificare che l’utente non autenticato possa:\begin{enumerate}
        \item navigare nella sezione dei profili seguiti
        \item selezionare il profilo che vuole rimuovere
        \item cliccare il pulsante de rimozione
    \end{enumerate} & N/I & \\

    TA9 & Verificare che l’utente non autenticato possa:\begin{enumerate}
    ...
    TA10 & Verificare che l’utente non autenticato possa:\begin{enumerate}
        \item navigare nella sezione impostazion
...
Come spiegato nelle Norme di Progetto,è desiderabile svolgere la verifica dei documenti facendo ispezione invece che walkthrough.
 Le liste di controllo vengono aggiornate nel corso del progetto dai verificatori man mano che notano errori ricorrenti.
...
\subsection{Struttura dei documenti}
{
    ...
    Caption assente &  Tutte le immagini e tabelle devono avere la caption &11
    A capo & Non bisogna spezzare la frasi andando a capo : complica la lettura del documento su Github&\\
...
\subsection{Non conformità con le Norme di Progetto}
{
    ...
    \toprule
    \endhead
    Formato errato date & Deve essere YYYY-MM-DD,sia all'interno dei documenti che nei nomi dei file &\\
