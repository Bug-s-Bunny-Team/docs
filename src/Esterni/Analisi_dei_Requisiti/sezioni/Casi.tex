...
\subsubsection{UC15.4 - Visualizzazione punteggio locale}
\begin{itemize}
    \item \textbf{Attore}: utente autenticato.
...
\subsection{UC17 - Visualizzazione lista globale}
\begin{itemize}
    \item \textbf{Attore}: utente autenticato.
...
\subsection{UC22 - Visualizzazione errore di utente già presente nel sistema}
\begin{itemize}
    \item \textbf{Attore}: utente autenticato.
...
\subsubsection{UC24.1 - Visualizzazione nome utente}
\begin{itemize}
    \item \textbf{Attore}: utente autenticato.
...
\subsubsection{UC24.3 - Visualizzazione numero seguaci}
\begin{itemize}
    \item \textbf{Attore}: utente autenticato.
    \item \textbf{Descrizione}: durante l'esplorazione dei profili social più seguiti,
...
\subsection{UC27 - Impostazione lista come vista predefinita}
\begin{itemize}
    \item \textbf{Attore}: utente autenticato.
...
\subsubsection{UC29.2 - Inserimento codice}
\begin{itemize}
    \item \textbf{Attore}: utente non autenticato.
...
\subsubsection{UC29.3 - Inserimento ripetizione nuova password}
\begin{itemize}
    \item \textbf{Attore}: utente non autenticato.
...
\subsubsection{UC29.4 - Conferma modifica password}
\begin{itemize}
    \item \textbf{Attore}: utente non autenticato.
...
\subsection{UC30 - Visualizzazione errore di inserimento codice}
\begin{itemize}
    \item \textbf{Attore}: utente non autenticato.
...
\subsection{UC31 - Visualizzazione errore di inserimento nuova password}
\begin{itemize}
    \item \textbf{Attore}: utente non autenticato.
    \item \textbf{Descrizione}: durante l'attività di password dimenticata l'utente deve ricevere un messaggio d'errore se l'inserimento della nuova password attuale non è andato a buon fine.
    \item \textbf{Scenario}: l'utente legge un messaggio d'errore. 
    \item \textbf{Precondizioni}: l'utente svolge la sessione di password dimenticata e la nuova password attuale inserita non è valida.
    \item \textbf{Postcondizioni}: l'utente ha ricevuto un messaggio d'errore.
\end{itemize}

\subsection{UC32 - Visualizzazione errore di inserimento nuova password non valida}
\begin{itemize}
    \item \textbf{Attore}: utente non autenticato.
...
\subsection{UC33 - Visualizzazione errore di ripetizione nuova password}
\begin{itemize}
    \item \textbf{Attore}: utente non autenticato.
    \item \textbf{Descrizione}: durante l'attività di modifica password l'utente deve ricevere un messaggio d'errore se l'inserimento della ripetizione della nuova password non è uguale alla nuova password.
    \item \textbf{Scenario}: l'utente legge un messaggio d'errore. 
