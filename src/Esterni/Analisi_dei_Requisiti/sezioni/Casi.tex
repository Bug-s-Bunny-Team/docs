...
\subsubsection{UC16 - Visualizzazione mappa globale}
\begin{itemize}
    \item \textbf{Attore}: l'utente è autenticato.
...
\subsubsection{UC17 - Visualizzazione lista globale}
\begin{itemize}
    \item \textbf{Attore}: l'utente è autenticato.
...
\subsubsection{UC18 - Visualizzazione mappa personalizzata}
\begin{itemize}
    \item \textbf{Attore}: l'utente è autenticato.
...
\subsubsection{UC19 - Visualizzazione lista personalizzata}
\begin{itemize}
    \item \textbf{Attore}: l'utente è autenticato.
    \item \textbf{Descrizione}: l'utente visualizza la mappa personalizzata se ha dei profili social seguiti.
    \item \textbf{Scenario}:
...
\subsection{UC24.1 - Visualizzazione nome utente}
\begin{itemize}
    \item \textbf{Attore}: l'utente è autenticato.
...
\subsection{UC24.2 - Visualizzazione numero contributi}
\begin{itemize}
    \item \textbf{Attore}: l'utente è autenticato.
    \item \textbf{Descrizione}: durante l'esplorazione dei profili social più seguiti,
...
\subsection{UC24.3 - Visualizzazione numero seguaci}
\begin{itemize}
    \item \textbf{Attore}: l'utente è autenticato.
    \item \textbf{Descrizione}: durante l'esplorazione dei profili social più seguiti,
