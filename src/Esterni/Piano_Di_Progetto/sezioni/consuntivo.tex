...
\subsubsection{Primo incremento - Costo} 
{
    ...
    \subsubsection{Consuntivo del periodo} {
        ...
        \begin{itemize}
            \item la sessione estiva ha comportato un ritardo per la revisione RTB. I membri del gruppo,
            ...
            \item  il secondo colloquio con l'azienda proponente, per conoscere meglio le tecnologie che si sarebbero 
                  ...
                  il 2022-05-16;
            \item sono sorti dei problemi da parte dell'azienda con AWS per il rilascio dei crediti e il gruppo ha dovuto aspettare 
