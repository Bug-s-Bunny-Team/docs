...
\subsubsection{Primo incremento - Costo} 
{
    ...
    \subsection{Consuntivo individuale} 
    ...
    dei componenti, fattore che ha permesso di limitare malcontento.
    {
        \setlength{\freewidth}{\dimexpr\textwidth-30\tabcolsep}
            ...
            \setlength{\belowrulesep}{0pt}
            \rowcolors{2}{Arancione!10}{white}
            \begin{longtable}{C{.3\freewidth} C{.11\freewidth} C{.11\freewidth} C{.11\freewidth} C{.11\freewidth} C{.11\freewidth} C{.11\freewidth} C{.15\freewidth}}
            \toprule
            \rowcolor{Arancione}
            \textcolor{white}{\textbf{Componente}}&
            \textcolor{white}{\textbf{Re}}&
            ...
            \rowcolor{white}
            \\
            \caption{\centering{Consuntivo orario finale}}
