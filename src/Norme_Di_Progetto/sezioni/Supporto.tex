\subsection{Documentazione}
	...
	\subsubsection{Norme tipografiche}
		...
		\subsubsection{Strumenti} %Aggiungere descrizione e utilizzo
			\begin{itemize}
				\item \textbf{LaTeX}
	...
	\subsection{Processo di Configurazione}
		...
		\paragraph{Tecnologie adottate}
			Per la gestione delle versioni è stato scelto di utilizzare il sistema di versionamento distribuito \emph{Git} con un \emph{repository} remoto presente su \emph{GitHub}. %Aggiungere link ??
		...
		\paragraph{Norme di branching}
			...
			\begin{itemize}
				...
				\item un \textbf{branch} per ogni documento. %Aggiungere altro?
			\end{itemize}
						...
						\subparagraph{Test}
							...
							I test sono ben progettati e scritti se e solo se:
								\begin{itemize}
									...
									%Magari Aggiungere altro
								\end{itemize}
							
							%Magari aggiungere i vari tipi di test: Unità, Integrazione, sistema, regressione ed collaudo
