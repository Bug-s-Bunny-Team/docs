\subsection{Documentazione}
	...
	\subsubsection{Versionamento}
		...
		\aCapo{}  
		Tutti i membri del gruppo possono apportare modifiche ai file elaborati, salvo quelli presenti nel ramo \textit{main} o nel ramo \textit{dev}. \\
		 Il ramo \textit{main} verrà aggiornato alle ultime modifiche prima di una delle revisioni tramite merge dal ramo \textit{dev}. \\
