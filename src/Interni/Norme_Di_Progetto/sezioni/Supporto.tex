		...
		\paragraph{Verbali} 
			...
			La struttura sarà quindi la seguente:
				\begin{itemize}
					...
					\item \textbf{Issue aperte:} vengono elencate le issue che sono state aperte su Github\G{} durante il verbale.		
				\end{itemize}
	...
	\subsubsection{Versionamento}
		...
		\aCapo{}  
			...
			\begin{itemize}
				...
				\item \emph{frontend}\G{}: \emph{branch}\G{} è stato utilizzato il framwork Svelte per la realizzazione del Frontend;
				\item \emph{dev}\G{}: \emph{branch}\G{} è stato utilizzato il linguaggio Phython\G{}.
			\end{itemize}
