	...
	\subsubsection{Norme tipografiche}
		...
		\subsubsection{Strumenti}
			...
			\begin{longtable}{L{.22\freewidth} L{.4\freewidth} L{.2\freewidth}}
				...
				\bottomrule
				\caption*{Metriche utilizzate per la valutazione della documentazione.}
			\end{longtable}
	...
	\subsubsection{Versionamento}
		...
		\aCapo{}
			...
			\begin{itemize}
				...
				\item \href{https://github.com/Bug-s-Bunny-Team/poc}{\textbf{docs}}: per la gestione e il versionamento del \textit{POC}.
			\end{itemize}
			...
			\subsubsection{Aspettative}
				...
				\subsubsection{Metriche}
					...
					\begin{longtable}{L{.22\freewidth} L{.4\freewidth} L{.2\freewidth}}
						...
						\textbf{MPP1} & Schedule variance & \S 6.1 MPP1 \\
