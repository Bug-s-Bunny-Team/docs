\subsection{Documentazione}
	...
	\subsubsection{Norme tipografiche}
		...
		\subsubsection{Strumenti}
			\begin{itemize}
				\item \textbf{\G:} stesura in bella copia dei documenti caricati poi sul repository\G{} del gruppo;
	...
	\subsubsection{Versionamento}
		...
		\aCapo{}  
			Per gestire il versionamento del codice sorgente, viene utilizzato il sistema di versionamento distribuito \emph{Git\G}, con un \emph{repository} remoto presente su \emph{GitHub\G}.
		...
		\aCapo{}
			...
			\begin{itemize}
				...
				\item \href{https://github.com/Bug-s-Bunny-Team/poc}{\textbf{docs}}: per la gestione e il versionamento del \textit{POC\G}.
			\end{itemize}
		...
		\subsubsection{Strumenti}
			Per la gestione della configurazione o versionamento il gruppo utilizza \emph{Visual Studio Code\G{}} o i seguenti client \emph{Git}:
				
				\begin{itemize}
					\item \textbf{GitHub Desktop}: Client ufficiale di \emph{GitHub\G{}} utilizzato per la gestione delle \emph{repository} \emph{Git};
		...
		\subsection{Gestione della qualità}
			...
			\subsubsection{Attività di processo}
				...
				\begin{itemize}
					...
					\item \textbf{Esecuzione}: attività che si occupa dell'esecuzione di ciò che è stato pianificato nell'attività precedente.ì;
