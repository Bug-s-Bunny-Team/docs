...
\setlength{\belowrulesep}{0pt}
\rowcolors{2}{Arancione!10}{white}
\begin{longtable}{L{.22\freewidth} L{.2\freewidth} L{.4\freewidth}}
	\toprule
	\rowcolor{Arancione}
	...
	\textbf{MPR2} & Percentuale Requisiti Obbligatori Soddisfatti & \S 6.2 Metriche per qualità di prodotto \\
...
\begin{longtable}{L{.22\freewidth} L{.2\freewidth} L{.4\freewidth}}
	...
	\textbf{MPR5} & Accoppiamento tra classi & \S 6.2 Metriche per qualità di prodotto \\
	\textbf{MPR6} & Profondità delle gerarchie & \S 6.2 Metriche per qualità di prodotto \\
	\textbf{MPR12} & Facilità di utilizzo & \S 6.2 Metriche per qualità di prodotto \\
...
\begin{longtable}{L{.22\freewidth} L{.2\freewidth} L{.4\freewidth}}
	...
	\textbf{MPR2} & Percentuale Requisiti Obbligatori Soddisfatti & \S 6.2 Metriche per qualità di prodotto \\
	\textbf{MPR3} & Code Coverage & \S 6.2 Metriche per qualità di prodotto \\
	\textbf{MPR6} & Profondità Gerarchie &  \S6.2 Metriche per qualità di prodotto \\
	\textbf{MPR7} & Numero Attributi per Classe & \S 6.2 Metriche per qualità di prodotto \\
	\textbf{MPR8} & Numero Parametri per Metodo & \S 6.2 Metriche per qualità di prodotto \\
	\textbf{MPR9} & Linee Codice per Metodo & \S 6.2 Metriche per qualità di prodotto \\
	\textbf{MPR10} & Linee Commento per Codice & \S 6.2 Metriche per qualità di prodotto \\
	\textbf{MPR14} & Complessità Ciclomatica Media & \S 6.2 Metriche per qualità di prodotto \\
